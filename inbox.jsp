    ...
    <div class="container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <%
                        String receiverEmail = (String) session.getAttribute("userEmail");
                        ...
                        if (receiverEmail != null) {
                            ...
                            try (Connection connection = DriverManager.getConnection(jdbcURL, dbUser, dbPassword);
                                 PreparedStatement stmt = connection.prepareStatement("SELECT * FROM emails WHERE receiver_email = ? AND deleted_by_receiver = FALSE")) {
                    ...
                    %>
                                    <tr>
                                        ...
                                        <td><%= body %></td>
                                        <td>
                                            <form action="deleteInboxEmail.jsp" method="POST">
